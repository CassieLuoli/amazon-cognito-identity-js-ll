...
**Forked from Amazon Cognito Identity Provider JavaScript SDK**

* Android gradle version is updated from 1.3.1 to 2.3.2
* Android sdk version 26 with tools updated to 26.0.2
...
* https://github.com/aws/amazon-cognito-identity-js-ll
...
Download the JavaScript [library file](https://raw.githubusercontent.com/aws/aws-amplify/master/packages/amazon-cognito-identity-js-ll/dist/amazon-cognito-identity.min.js) and place it in your project.
...
* Install the Amazon Cognito Identity SDK for JavaScript and the Webpack tool into your project with `npm` (the Node
  ...
  > npm install --save amazon-cognito-identity-js-ll
  ```
...
See [Using NPM and Webpack](https://github.com/aws/amazon-cognito-identity-js-ll#using-npm-and-webpack) for more information on NPM.
...
```
react-native link amazon-cognito-identity-js-ll
```
...
For an example using babel-webpack of a React setup, see [babel-webpack example](https://github.com/aws/amazon-cognito-identity-js-ll/tree/master/examples/babel-webpack).
...
```javascript
    ...
    // Modules, e.g. Webpack:
    var AmazonCognitoIdentity = require('amazon-cognito-identity-js-ll');
    var CognitoUserPool = AmazonCognitoIdentity.CognitoUserPool;

    // ES Modules, e.g. transpiling with Babel
    import { CognitoUserPool, CognitoUserAttribute, CognitoUser } from 'amazon-cognito-identity-js-ll';
```
...
```
*note that you can not replace the login key with a variable because it will be interpreted literally. if you want to use a variable, the resolution to [issue 17](https://github.com/aws/amazon-cognito-identity-js-ll/issues/162) has a working example*
